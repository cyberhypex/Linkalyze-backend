...
import com.Link.Linkalyz.security.jwt.JwtAuthenticationResponse;
import com.Link.Linkalyz.security.jwt.JwtUtils;
...
public class UserService {
    ...
    public JwtAuthenticationResponse authenticateUser(LoginRequest loginRequest){
        ...
        SecurityContextHolder.getContext().setAuthentication(authentication);//holding data for current session
